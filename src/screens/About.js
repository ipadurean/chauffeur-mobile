...
export default function About() {
  return (
    <View style={globalStyles.container}>
      <ScrollView>
      <Text style={globalStyles.paragraph}>Chauffeur is an app that connects private chauffeurs with customers looking for transportation in an upscale vehicle. 
